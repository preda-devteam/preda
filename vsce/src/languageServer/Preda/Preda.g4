...
expression locals [int expressionType = -1]
  ...
  | expression '*' expression                                                                                  {$expressionType = 12;}
  ...
  | expression '?' expression ':' expression                                                                   {$expressionType = 30;}
  | expression '=' expression                                                                                  {$expressionType = 31;}
  ...
  | primaryExpression                                                                                          {$expressionType = 42;}
  ;
