...
typedef jd_main_controller * jd_main_ptr;
...
METHODDEF(void) jd_process_data_simple_main
 ...
 */
{
  jd_main_ptr mainp = (jd_main_ptr) cinfo->main;
  int ci, rgroup;
...
METHODDEF(void)
jd_start_pass_main (j_decompress_ptr cinfo, J_BUF_MODE pass_mode)
{
  jd_main_ptr mainp = (jd_main_ptr) cinfo->main;
  ...
  case JBUF_PASS_THRU:
    if (cinfo->upsample->need_context_rows) {
      ...
      mainp->pub.process_data = jd_process_data_simple_main;
    }
...
METHODDEF(void)
jd_process_data_simple_main (j_decompress_ptr cinfo,
...
jinit_d_main_controller (j_decompress_ptr cinfo, boolean need_full_buffer)
{
  ...
  mainp = (jd_main_ptr)
    (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, JPOOL_IMAGE,
				SIZEOF(jd_main_controller));
  cinfo->main = &mainp->pub;
  mainp->pub.start_pass = jd_start_pass_main;
