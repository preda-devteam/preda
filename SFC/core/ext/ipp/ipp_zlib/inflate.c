...
int flush;
{
    ...
    for (;;)
        ...
        case CODELENS:
            ...
            if( ippStsNoErr != IPPCALL(ippsInflateBuildHuffTable)( state->lens, state->nlen, state->ndist,
        ...
        case LENEXT:
            { /* block */
              ...
              if( ippStsNoErr != IPPCALL(ippsInflate_8u)( &next, &have, (Ipp32u*)&hold, &bits, state->wnext,
                                                 &put, &left, out - left,
