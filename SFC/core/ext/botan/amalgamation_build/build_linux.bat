...
python configure.py --amalgamation --disable-shared --cc=gcc --no-autoload --enable-modules=%MODULES% --cpu=x86_32 --os=linux --with-local-config=config_linux.h
move /Y botan_all*.h ..\platforms\linux_x86\
move /Y botan_all*.cpp ..\platforms\linux_x86\

python configure.py --amalgamation --disable-shared --cc=gcc --no-autoload --enable-modules=%MODULES% --cpu=x86_64 --os=linux --with-local-config=config_linux.h
